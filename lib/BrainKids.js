var Bn = ( function($, _) {
  ...
  Brain.element.prototype.initialization = function(opt) {
    ...
    console.log("in the element's initialization::", this, this['targetLayer'], this["originValue"]);
    this.dispatch({type: 'element:add', targetLayer: this.targetLayer, sender: this})
  }
...
var l = new Bn.layer(3)
var m = new Bn.layer(2)
var n = new Bn.layer(1)
var o = new Bn.layer(0)

var th = new Bn.helper.tipElement({id: 'names', className: 'names', targetLayer: 'layer3', originValue: {headLine: 'hey', info: 'this is a alert infomation'}})
...
//
// e.render = function(h, info) {
//   var t = _.template(warningTemplate)
//   this.el.innerHTML = t({headLine: h, info: info})
//   // this.el.children[0].appendChild(closeButton)
//   this.el.children[0].children[2].owner = this
//   this.el.children[0].children[2].addEventListener('click', this.closeSelf, false)
//   // $(closeButton).click(function() {
//   //   $(closeButton.owner.el).hide(0, function() {
//   //     closeButton.owner.dispatch({type: 'element:hide', targetLayer: closeButton.owner.targetLayer, sender: closeButton.owner})
//   //   })
//   // })
// }

// e.render("alert", "don't be cry")

// function decorator(source, fn, context, sourceArgs=[], fnArgs=[]) {
//   // if (Object.prototype.toString(source) === ‘[object Function]’ && Object.prototype.toString(fn) === ‘[object Function]’) {
//     var temp = source
//     source = function() {
//       temp.apply(context, sourceArgs)
//       fn.apply(context, sourceArgs)
//     }
//     return source
//   // }
// }
...
// }
//
// l.registInnerEvent = decorator(l.registInnerEvent, regist, l)
//
l.registInnerEvent()
th.dispatch({type: 'element:add', targetLayer: th.targetLayer, sender: th})
// e.dispatch({type: 'element:add', targetLayer: e.targetLayer, sender: e})

console.log(l, m, n, o, th, c)
