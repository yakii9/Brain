var Bn = ( function($, _) {
  ...
  Brain.element.prototype.setOptions =  function(opt) {
    var attrs = ["model", "collection", "id", "attributes", "className", "tagName", "children", "ele", "targetLayer"]


    for (var key in opt) {
      console.log("in the element's setOptions:", this, opt, key);
  ...
  Brain.element.prototype.initialization = function(opt) {
    console.log("in the element's initialization::", this, this['targetLayer']);
