  ...
  Brain.layer = function(layerNum, children=null, triggerable=null, dispatchible=null) {
    ...
    self.initialization = function() {
      for (var i=0; i<this.children.length; i++) {
        ...
        this.listenTo(this.children[i])
        this.children[i].router({type: 'page:init'})
      }
...
// **************************************************************
var layer0 = new Bn.layer(0)
layer0.initialization()

var layer1 = new Bn.layer(1)
layer1.initialization()

var layer2 = new Bn.layer(2)
layer2.initialization()

var layer3 = new Bn.layer(3)
// layer3.initialization()
layer3.router({type: 'page:init'})
